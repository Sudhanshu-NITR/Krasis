  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            The <span className="text-indigo-400">Hybrid Search</span> Pattern <br /> for Developer Platforms.
            </h1>
            ...
            Don't let "charge a card" fail because your API calls it <code className="bg-white/10 px-1.5 py-0.5 rounded text-indigo-300 font-mono text-sm">create_payment_intent</code>.
            Krasis blends BM25 keyword precision with dense vector semantics for perfect retrieval.
            </p>
            ...
            <button className="w-full md:w-auto px-8 py-3.5 rounded-full bg-white text-black font-semibold hover:bg-zinc-200 transition-all flex items-center justify-center gap-2 group">
                Start Building
                <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="w-full md:w-auto px-8 py-3.5 rounded-full bg-zinc-900 border border-zinc-800 text-zinc-300 font-medium hover:bg-zinc-800 transition-all flex items-center justify-center gap-2">
